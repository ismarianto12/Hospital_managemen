...
<head>
    ...
    <title>{{ App_help::rian('Selamat datan ') }} </title>
    <!-- Favicon -->
    ...
    <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="dashboard.html">
                <img
                    src="https://s3-ap-southeast-1.amazonaws.com/lokerindonesia.com/wp-content/uploads/2018/09/18205358/7f315aeaa679401d525f52a7e3689d82-resize-1024x306.png">
            </a>
                ...
                <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                    ...
                    <li class="nav-item d-none d-lg-block ml-lg-4">
                        <a href="https://www.creative-tim.com/product/argon-dashboard-pro?ref=ad_upgrade_pro"
                            ...
                            <span class="nav-link-inner--text">Daftar Dokter Hari ini</span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            ...
                            <p class="text-lead text-white">Pendaftaran peserta pasien rumah sakit sentra medika.</p>
                        </div>
                    </div>
                </div>
            </div>
